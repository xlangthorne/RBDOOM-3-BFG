...
================================================
*/
export class idCallbackStatic : public idCallback
{
public:
...
================================================
*/
export template< class T, typename A1 >
...
========================
*/
export ID_INLINE_EXTERN idCallbackStatic MakeCallback(void (*f)())
{
